          ...
          <div className="flex flex-col items-center w-full max-w-2xl p-8">
            ...
            <div className="p-4 w-full rounded bg-muted overflow-auto mb-6 text-center">
              <p className="text-sm text-muted-foreground whitespace-break-spaces">
                A interface encontrou uma falha e foi interrompida com segurança. O erro real foi registrado no console para diagnóstico.
              </p>
              {this.state.error?.message ? (
                <p className="mt-3 text-sm font-medium text-foreground">{this.state.error.message}</p>
              ) : null}
            </div>
