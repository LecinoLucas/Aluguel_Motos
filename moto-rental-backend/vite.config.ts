...
const FRONTEND_ROOT = path.resolve(BACKEND_ROOT, "../moto-rental-frontend");
export const frontendClientRoot = path.join(FRONTEND_ROOT, "client");
const frontendPublicRoot = path.join(frontendClientRoot, "public");
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      "@": path.join(frontendClientRoot, "src"),
      "@shared": sharedRoot,
      "@assets": path.join(FRONTEND_ROOT, "attached_assets"),
    },
  },
  envDir: BACKEND_ROOT,
  root: frontendClientRoot,
