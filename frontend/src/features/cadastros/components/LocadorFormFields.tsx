...
import { formatCepInput, formatCpfInput, formatPhoneInput, formatRgInput } from "../format";
import type { LocadorField, LocadorFormData, LocadorFormErrors } from "../types";

interface LocadorFormFieldsProps {
  form: LocadorFormData;
  errors?: LocadorFormErrors;
  onChange: (field: LocadorField, value: string) => void;
  disableCpf?: boolean;
}

export function LocadorFormFields({
  form,
  errors = {},
  onChange,
  disableCpf = false,
